...
// UpDate Profile
 ...
 // Change password or Updated Password
...
export const resetPassword=(id,token,password)=>async(dispatch)=>{
    ...
    try {
        ...
        const config={headers:{"Content-Type":"application/json"} };
        const {data}= await axios.put(`/api/v1/password/reset/${id}/${token}`,password,config)
 ...
 export const updateUser=(id, userData)=>async(dispatch)=>{
    ...
    try {
     ...
     dispatch({type:USER_UPDATED_SUCCESS, payload:data.success})
